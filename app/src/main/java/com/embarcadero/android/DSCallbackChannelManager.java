...
import com.embarcadero.android.DSAdmin.NotifyCallbackReturns;
...
public class DSCallbackChannelManager {
	 ...
	 * @param CallbackId
	 * @param Callback
	 *            the class that implements the method "showQuestion"
	...
	static class WorkerThread extends Thread {
		...
		/**
		 * send the the contents of the server response at the "showQuestion" method
		...
		/**
		 * prepare the Post request and then use the showQuestion method
		 * 
		 * @param Url
		 * @param Param
		 * @return
