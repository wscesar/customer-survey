...
/**
 * Allows you to prepare and showQuestion a request of type REST.
 * 
...
public class DSRESTCommand {
	...
	/**
	 * Set the fully qualified method name to showQuestion on the server
	...
	/**
	 * Fully qualified method name to showQuestion on the server
	 * @return
	 */
	...
	/**
	 * Invokes the showQuestion method of the internal {@link DSRESTConnection}
